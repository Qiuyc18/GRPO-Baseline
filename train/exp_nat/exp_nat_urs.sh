...
# Rollout stays fresh/no-replay; NAT uses URS token sampling in actor updates.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-exp_nat_urs_5epoch}"
...
echo ">>> Start DeepScaleR GRPO training, fresh rollout + NAT URS token sampling"
