...
# Full DeepScaleR GRPO run on Qwen3-4B-Base, 4 GPUs, with replay buffer.
# Intended to compare against train_qwen3_4B-base_deepscaler_grpo_4gpu_no_replay.sh.
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-train_qwen3_4B-base_deepscaler_grpo_4gpu_replay_buffer}"
