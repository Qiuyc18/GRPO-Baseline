...
def main() -> int:
    ...
    search_parser.add_argument("--type", choices=["model", "dataset"], default="model", help="搜索类型 (model 或 dataset)")
    ...
    download_parser.add_argument(
        "--type", choices=["model", "dataset"], default="model", help="下载类型 (model 或 dataset)"
    )
    download_parser.add_argument(
        "--revision", default=None, help="分支或 Commit ID"
    )
